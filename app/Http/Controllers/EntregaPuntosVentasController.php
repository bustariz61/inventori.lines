...
use App\Models\PersonaPuntoVenta;
...
class EntregaPuntosVentasController extends Controller
{
    public function mostrar(){
        $entrega = DB::table('persona_punto_venta as a')
    ...
    return view('Vistas.PuntosVentas.mostrar', ['entrega'=> $entrega ]);
    ...
    public function registrar(){
        return view('Vistas.PuntosVentas.registrar');
    }
    ...
    public function guardar(Request $request){
       ...
       //dd ($cedula, $primer_nombre, $primer_apellido, $telefono_ubicacion, $ubicacion, $cargo, $acueducto, $departamento, $numero_linea, $numero_sim);
        ...
        for ($i = 1; $i <= count($segunda_cedula)-1; $i++) {
            $camposDinamicos = new PersonaPuntoVenta();
    ...
    $entrega = PersonaPuntoVenta::find($id);
    return view('Vistas.PuntosVentas.editar', compact('entrega'));
    ...
    $entrega = PersonaPuntoVenta::findOrFail($id);
    ...
    $entrega->modeo = $request->input('modelo');
    ...
    return redirect()->route('entregaPuntosVentas.mostrar', compact('id_entrega'));
    }
    ...
    public function eliminar($id){
       ...
       /* $retiro->delete();
        ...
        $entrega->save();
        if($entrega->save())
        return redirect()->route('entregaPuntosVentas.mostrar');
    }
    ...
    ->select('a.id', 'a.segunda_cedula', 'a.segundo_nombre', 'a.segundo_apellido',
     'a.fecha', 'a.segunda_ubicacion', 'a.segundo_cargo', 'a.segundo_acueducto',
      'a.segundo_departamento', 'a.status', 'c.cedula',
      'c.primer_nombre', 'c.primer_apellido', 'a.sim','a.marca','a.imeil','a.serial',
      'a.nroBien','a.antena','a.fecha', 'a.modelo',                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  'c.primer_nombre', 'c.primer_apellido')
    ...
    public function pdf($id){
        $query = PersonaPuntoVenta::find($id);
        ...
        $pdf = Pdf::loadView('Vistas.PuntosVentas.pdf', ['entrega' =>$entrega], compact('dia', 'mes'));
