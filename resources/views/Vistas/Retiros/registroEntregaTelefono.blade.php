...
<br>
<br>
<h1 class="text-white" align="center">RETIRO TELEFONOS</h1>
<div class="table-responsive">
  <div id="container">

    <form action="{{ route('registroEntregaTelefono.guardarEntregaTelefono') }}" method="POST" id="form">
      @csrf
      <div class="table-responsive">
        <!-- Projects table -->
          ...
          <br>          
              ...
              <tbody>
                <tr>
                    ...
                    <td><b><input name="fecha2[]" id="segundo_telefono" class="form-control validate-field" type="date" style="width: 140px; height: 40px; color:black"></b></td>
                ...
                <tr>
                  ...
                  <th scope="col" style="color: black">Cargador</th>
                  <th scope="col" style="color: black">Protector</th>
                  <th scope="col" style="color: black">Forro</th>
                  <th scope="col" style="color: black">Activo</th>
                  <th scope="col" style="color: black">Imei 1</th>
                  <th scope="col" style="color: black">Imei 2</th>
                </tr>
                <tr>
                    ...
                    <td><b><input name="color[]" id="color" class="form-control validate-field" type="text" style="width: 150px; height: 40px; color:black"></b></td>
                    ...
                    <td><b><input name="cargador[]" id="cargador" class="form-control validate-field" type="text" style="width: 150px; height: 40px; color:black"></b></td>
                    <td><b><input name="protector_pantalla[]" id="protector_pantalla" class="form-control validate-field" type="text" style="width: 150px; height: 40px; color:black"></b></td>
                    <td><b><input name="forro[]" id="forro" class="form-control validate-field" type="text" style="width: 150px; height: 40px; color:black"></b></td>
                    <td><b><input name="activo[]" id="activo" class="form-control validate-field" type="text" style="width: 150px; height: 40px; color:black"></b></td>
                    <td><b><input name="imei1[]" id="imei1" class="form-control validate-field" type="text" style="width: 150px; height: 40px; color:black"></b></td>
                    <td><b><input name="imei2[]" id="imei2" class="form-control validate-field" type="text" style="width: 150px; height: 40px; color:black"></b></td>
                </tr>
...
<script>
  ...
  function validarInput() {
    ...
    $(".validate-field").each(function(i, input) {
      ...
      if (fieldId === 'color'){ // Replace 'field1' with the ID of the first field
        if ($(input).val().trim() === ''){
          $(input).addClass('campo_con_errores');
          errores++;
        } else {
      ...
      if (fieldId === 'cargador'){ // Replace 'field1' with the ID of the first field
        if ($(input).val().trim() === ''){
          $(input).addClass('campo_con_errores');
          errores++;
        } else {
      ...
      if (fieldId === 'protector_pantalla'){ // Replace 'field1' with the ID of the first field
        if ($(input).val().trim() === ''){
          $(input).addClass('campo_con_errores');
          errores++;
        } else {
      ...
      if (fieldId === 'forro'){ // Replace 'field1' with the ID of the first field
        if ($(input).val().trim() === ''){
          $(input).addClass('campo_con_errores');
          errores++;
        } else {
      ...
      if (fieldId === 'activo'){ // Replace 'field1' with the ID of the first field
        if ($(input).val().trim() === ''){
          $(input).addClass('campo_con_errores');
          errores++;
        } else {
      ...
      if (fieldId === 'imei1'){ // Replace 'field1' with the ID of the first field
        if ($(input).val().trim() === ''){
          $(input).addClass('campo_con_errores');
          errores++;
        } else {
      ...
      if (fieldId === 'imei2'){ // Replace 'field1' with the ID of the first field
        if ($(input).val().trim() === ''){
          $(input).addClass('campo_con_errores');
          errores++;
        } else {
    ...
    if(errores<1 && i2>16 && errores2<1) {
      $("#form").submit();
      
    } else if(i2<=16 && errores2<1){
