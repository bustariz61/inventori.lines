...
<body>
    ...
    <p class="text-justify">
        ...
        el cual tiene el <b>Cargo</b> de <b>{{ $en->segundo_cargo }}</b> <b>y se encuentra ubicado en </b> <b>{{ $en->segunda_ubicacion }}</b> se deja constar la entrega de una linea movil( <b>{{ $en->numero_linea }}</b> ),
        con las siguientes caresteristicas:
    </p>
    <br>
    <p>
        1.<b>NUMERO</b>:<b>{{ $en->numero_linea }}</b>
        <br>
        1.<b>SIM</b>:<b>{{ $en->numero_sim }}</b>
    </p>
@endforeach 
    <P><b>
