...
<head>
    <meta charset="UTF-8">
    <title>Entrega Punto Venta</title>
...
@foreach ($entrega as $en)
    ...
    <p>
        1.<b>Sim</b>:{{ $en->sim }}
        <br>
        2.<b>Marca</b>:{{ $en->marca }}
        <br>
        3.<b>Modelo</b>:{{ $en->modelo }}
        <br>
        4.<b>Imeil</b>:{{ $en->imeil }}
        <br>
        5.<b>Serial</b>:{{ $en->serial }}
        <br>
        6.<b>Número de Bien</b>:{{ $en->nroBien }}
        <br>
        7.<b>Antena</b>:{{ $en->antena }}
        <br>
    </p>
    @endforeach
