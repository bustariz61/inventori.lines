...
<div class="table-responsive">
  <div id="container">
    ...
    <form action="{{ route('registroEntregaPuntosVentas.guardar') }}" method="POST" id="form">
      @csrf
      <div class="table-responsive">
        <!-- Projects table -->
...
<br>
      <h2>Asignado a</h2>
      <button type="button" class="btn btn-primary" onclick="addDynamicField()">Asignar Punto de Venta</button>
